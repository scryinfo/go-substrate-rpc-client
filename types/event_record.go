...
type EventRecords struct {
	...
	Council_Proposed                   []EventCouncilProposed                   //nolint:stylecheck,golint
	Council_Voted                      []EventCouncilVoted                      //nolint:stylecheck,golint
	Council_Approved                   []EventCouncilApproved                   //nolint:stylecheck,golint
	Council_Disapproved                []EventCouncilDisapproved                //nolint:stylecheck,golint
	Council_Executed                   []EventCouncilExecuted                   //nolint:stylecheck,golint
	Council_MemberExecuted             []EventCouncilMemberExecuted             //nolint:stylecheck,golint
	Council_Closed                     []EventCouncilClosed                     //nolint:stylecheck,golint
